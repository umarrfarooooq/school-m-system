...
const NewsLetter = () => {
  ...
  return (
    <div style={{backgroundColor:"#9747FF"}} className="flex flex-col items-start py-24 gap-[48px] relative">
    <div className="container relative self-stretch w-full">
    <div style={{backgroundColor:"#FFFBFA"}} className="flex items-center justify-center gap-[10px] py-8 px-1 sm:p-[88px] relative self-stretch w-full flex-[0_0_auto] rounded-[16px] overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center gap-[24px] relative self-stretch w-full flex-[0_0_auto] rounded-[8px]">
            <div className="flex items-center justify-center relative self-stretch w-full flex-[0_0_auto]">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M20 4H4C2.89543 4 2 4.89543 2 6V18C2 19.1046 2.89543 20 4 20H20C21.1046 20 22 19.1046 22 18V6C22 4.89543 21.1046 4 20 4Z" stroke="#8C979C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M22 7L13.03 12.7C12.7213 12.8934 12.3643 12.996 12 12.996C11.6357 12.996 11.2787 12.8934 10.97 12.7L2 7" stroke="#8C979C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
              </span>
