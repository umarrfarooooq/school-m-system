...
const ServiceCard = (props) =>{
    ...
    return(
        <>
            <div className="rounded-2xl bg-[#FFFBFA] h-fit md:my-0 cursor-pointer relative overflow-hidden hover:shadow-md p-3 hover:outline hover:outline-[#FFF500] outline-1 transition-all">
